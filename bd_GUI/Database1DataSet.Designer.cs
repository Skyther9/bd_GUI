...
namespace bd_GUI {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int SerialNum, string name, string manufacturer, string date) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow FindBySerialNum(int SerialNum) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int SerialNum {
                get {
                    return ((int)(this[this.tableTable.SerialNumColumn]));
                }
                set {
                    this[this.tableTable.SerialNumColumn] = value;
                }
            }
...
namespace bd_GUI.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([SerialNum] = @Original_SerialNum) AND ([name] " +
                "= @Original_name) AND ([manufacturer] = @Original_manufacturer) AND ([date] = @O" +
                "riginal_date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([SerialNum], [name], [manufacturer], [date]) VALUES (@" +
                "SerialNum, @name, @manufacturer, @date);\r\nSELECT SerialNum, name, manufacturer, " +
                "date FROM [Table] WHERE (SerialNum = @SerialNum)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [SerialNum] = @SerialNum, [name] = @name, [manufacturer] = @manufacturer, [date] = @date WHERE (([SerialNum] = @Original_SerialNum) AND ([name] = @Original_name) AND ([manufacturer] = @Original_manufacturer) AND ([date] = @Original_date));
SELECT SerialNum, name, manufacturer, date FROM [Table] WHERE (SerialNum = @SerialNum)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::bd_GUI.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SerialNum, name, manufacturer, date FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_SerialNum, string Original_name, string Original_manufacturer, string Original_date) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_SerialNum));
        ...
        public virtual int Insert(int SerialNum, string name, string manufacturer, string date) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(SerialNum));
            if ((name == null)) {
        ...
        public virtual int Update(int SerialNum, string name, string manufacturer, string date, int Original_SerialNum, string Original_name, string Original_manufacturer, string Original_date) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(SerialNum));
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_SerialNum));
            if ((Original_name == null)) {
                throw new global::System.ArgumentNullException("Original_name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string manufacturer, string date, int Original_SerialNum, string Original_name, string Original_manufacturer, string Original_date) {
            return this.Update(Original_SerialNum, name, manufacturer, date, Original_SerialNum, Original_name, Original_manufacturer, Original_date);
        }
    }
